  ...
  return (
    ...
    >
      ...
      <Stack spacing={1}>
        ...
        <Text fontSize="4vw" color="gray.600">
...
export const PointCard = ({ score, areaName }) => {
  return (
    ...
    >
      ...
      <Text fontSize="10vw" fontWeight="normal" color="gray.500" m="0">
        {score}
      </Text>
      <HStack>
...
export const PlaceCard = ({ img, placeName }) => {
  return (
    ...
    >
      ...
      <Image src={img} w="100%" h="45%" objectFit="cover" />
      <Text fontSize="4vw" color="gray.600" fontWeight="normal">
        {placeName}
      </Text>
    </VStack>
  );
